...
@section('title', 'Tambah Mahasiswa – AbsensiKu')
...
<div class="px-4 pt-4 pb-4 space-y-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-base font-extrabold text-slate-800">Tambah Mahasiswa</h1>
            <p class="text-xs text-slate-500">Lengkapi data mahasiswa baru</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-5">
        <form method="POST" action="{{ route('mahasiswa.store') }}" class="space-y-4">
            ...
            {{-- Password --}}
            <div class="space-y-1">
                <label class="text-xs font-semibold text-slate-600">Password Awal</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-3 flex items-center pointer-events-none text-slate-400">
